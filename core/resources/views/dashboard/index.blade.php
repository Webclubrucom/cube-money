...
<div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-7" style="font-size:11px;">
                                <div class="numbers">
                                    ...
                                    <span class="incomethismonth"></span><span class="currency"></span>
                                </div>
                            </div>
                        </div>
                        <div class="footer">
                            <hr>
                            <div class="stats">
                                <i class="ti-reload color-white"></i> <span class="color-white"><?php echo trans('lang.in_this_month');?></span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-7" style="font-size:11px;">
                                <div class="numbers">
                                    ...
                                    <span class="expensemonth"></span><span class="currency"></span>
                                </div>
                            </div>
                        </div>
                        <div class="footer">
                    ...
                    <div class="content">
                        <div class="row">
                            ...
                            <div class="col-xs-7" style="font-size:11px;">
                                <div class="numbers">
                                    <p><?php echo trans('lang.income');?></p>
                                    <span class="incomeday"></span><span class="currency"></span>
                                </div>
                            </div>
                        </div>
                        <div class="footer">
                            ...
                            <div class="stats color-white">
                                <i class="ti-reload color-white"></i> <span class="color-white"><?php echo trans('lang.today');?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="content">
                        <div class="row">
                            ...
                            <div class="col-xs-7" style="font-size:11px;">
                                <div class="numbers">
                                    <p><?php echo trans('lang.expense');?></p>
                                    <span class="expenseday"></span><span class="currency"></span>
                                </div>
                            </div>
                        </div>
                        <div class="footer">
		...
		<div class="row">
			<div class="col-md-7">
                <div class="card">
                    <div class="header">
                        <h4 class="title"> <?php echo trans('lang.income_vs_expense');?><h4>
			...
			<div class="col-md-5">
                <div class="card">
                    <div class="header">
                        <h4 class="title"><?php echo trans('lang.account_balance');?><h4>
		...
		<div class="row">
			<div class="col-md-4">
                <div class="card">
                    <div class="header">
                        <h5 class="title"><?php echo trans('lang.expense_by_category');?><h5>
			...
			<div class="col-md-4">
                <div class="card">
                    <div class="header">
                        <h5 class="title"><?php echo trans('lang.income_by_category');?><h5>
			...
			<div class="col-md-4">
                ...
                <div class="card">
                    <div class="header">
                        <h5 class="title"><?php echo trans('lang.budget');?><h5>
					...
					tooltips: {
					  callbacks: {
						...
						label: function(tooltipItem, data) {
						  return data['datasets'][0]['data'][tooltipItem['index']].toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + ' ' + $('.currency').val();
						},
