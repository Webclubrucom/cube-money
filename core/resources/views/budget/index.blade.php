                ...
                <div class="card">
                    <div class="header">
						<div class="row">
							...
							<div class="col-lg-6">
							<div class="pull-right"><a href="#'" data-toggle="modal" data-target="#add" class="btn btn-sm btn-fill btn-info"><i class="ti-plus"></i> Добавить</a></div>
							</div>
						</div>
                    </div>
                    <div class="content">
				...
				<div class="form-group">
                  <label><small class="req text-danger">* </small><?php echo trans('lang.amount');?></label>
					<div class="input-group">
						...
						<input class="form-control number" id="amount" name="amount" type="text" placeholder="<?php echo trans('lang.amount');?>">
						<span class="input-group-addon currency" style="border: 1px solid #cecece;"></span>
					</div>
                </div>
              </div>
...
$(document).ready(function() {
	...
	return '<div class="col-lg-6"><table cellpadding="10" cellspacing="0" border="0"  class="table-hover" style="padding-left:50px;">'+
			...
			'<h3 style="font-weight: 500;" class="text-left">'+
				'<span class="money-area"><span  style="font-weight:bold;" id="remainingbudget"></span>'+' '+'<span style="font-weight:bold;" id="currencybudget"></span></span>'+
			'</h3>'+
			'<div class="row">'+
					'<div class="col-xs-6">'+
