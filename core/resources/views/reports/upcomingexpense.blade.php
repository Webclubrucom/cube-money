    ...
    <div class="container-fluid">
		<div class="row">
			<div class="col-lg-12 col-md-11">
				 <div class="card">
					<div class="header">
						<h4 class="title"><?php echo trans('lang.upcoming_expense_reports');?></h4>
					</div>
					<div class="content">
						<div class="row">
		...
		<div class="row">
			<div class="col-lg-6">
				<div class="card">
					<div class="header">
						<div class="pull-left">
							<h5><b><?php echo trans('lang.12_monthly__upcoming_expense_chart');?></b></h5>
						</div>
						<div class="pull-right">
							<div class="text-success">
								<b><span id="totalyear"></span> <span class="currencys"></span></b><br/>
			...
			<div class="col-lg-6">
				<div class="card">
					<div class="header">
						<h5><b><?php echo trans('lang.upcoming_expense_by_category');?> (<?php echo date("Y");?>)</b></h5>
					</div>
					<div class="content">
...
$(document).ready(function() {
    ...
    var table = $('#data').DataTable( {
            ...
            ajax: {
				...
				data: function (d) {
					...
					d.fromdate = $('input[name=fromdate]').val().split(".").reverse().join("-");
					d.todate = $('input[name=todate]').val().split(".").reverse().join("-");
				},
			},
			"language": {
            "decimal":        "",
			...
			buttons: [
				{
					...
					title: '<?php echo trans('lang.upcoming_expense_reports');?>',
	...
	$.ajax({
        type: "GET",
        url: "{{ url('home/upcomingexpensebycategoryyearly')}}",
        dataType: "json",
        success: function (data) {
			var label = [];
			var amount = [];
