				...
				<div class="col-lg-12 col-md-11">
                    <div class="header">
						<div class="row">
							...
							<div class="col-lg-6">
							<div class="pull-right"><a href="#'" data-toggle="modal" data-target="#add" class="btn btn-sm btn-fill btn-info"><i class="ti-plus"></i> <?php echo trans('lang.add_income_category');?></a></div>
							</div>
						</div>
				...
				<div class="col-lg-12 col-md-11">
                    <div class="header">
						<div class="row">
							...
							<div class="col-lg-6">
							<div class="pull-right"><a href="#'" data-toggle="modal" data-target="#addsub" class="btn btn-sm btn-fill btn-info"><i class="ti-plus"></i><?php echo trans('lang.add_sub_category');?></a></div>
							</div>
						</div>
          ...
          <div class="modal-content">
            <form action="#" id="form">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo trans('lang.add_income_category');?></h4>
              </div>
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-fill" id="save"><?php echo trans('lang.save');?></button>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo trans('lang.close');?></button>
              </div>
            </form>
          </div>
        </div>
 ...
 <div class="modal fade" id="delete" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
		   <input type="submit" class="btn btn-primary btn-fill" id="dodelete" value="<?php echo trans('lang.delete');?>"/>
          <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo trans('lang.close');?></button>
        </div>
      </div>
    </div>
          ...
          <div class="modal-content">
            <form action="#"  id="form">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-fill" id="saveedit"><?php echo trans('lang.save');?></button>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo trans('lang.close');?></button>
              </div>
            </form>
          </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <form action="#" id="form">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php echo trans('lang.add_sub_income_category');?></h4>
              </div>
			  <div id="message" style="display:none;" class="alert alert-warning"><?php echo trans('lang.all_field_required');?></div>
              <div class="modal-body">
				<div class="form-group">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-fill" id="subsave"><?php echo trans('lang.save');?></button>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo trans('lang.close');?></button>
              </div>
            </form>
          </div>
 ...
 <div class="modal fade" id="deletesub" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
		   <input type="submit" class="btn btn-primary btn-fill" id="subdodelete" value="<?php echo trans('lang.delete');?>"/>
          <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo trans('lang.close');?></button>
        </div>
      </div>
    </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <form action="#"  id="form">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php echo trans('lang.edit_sub_income_category');?></h4>
              </div>
			  <div id="message" style="display:none;" class="alert alert-warning"><?php echo trans('lang.all_field_required');?></div>
              <div class="modal-body">
				<div class="form-group">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-fill" id="subsaveedit"><?php echo trans('lang.save');?></button>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo trans('lang.close');?></button>
              </div>
            </form>
          </div>
...
$(document).ready(function() {
    ...
    $('#data').DataTable( {
			...
			buttons: [
				{
					extend: 'copy',
					text:   'Копировать <i class="fa fa-files-o"></i>',
				...
				},
				{
					...
					title: '<?php echo trans('lang.income_category_list');?>',
					className: 'btn btn-sm btn-fill btn-info ',
					text:   'Печать <i class="fa fa-print"></i>',
					exportOptions: {
						columns: [ 1, 2]
					}
				}
	...
	$('#datasub').DataTable( {
            ...
            "decimal":        "",
                ...
                "paginate": {
                    ...
                    "last":       "<?php echo trans('lang.dlast');?>",
                    "next":       "<?php echo trans('lang.dnext');?>",
                    "Назад":   "<?php echo trans('lang.dНазад');?>"
                }
            },
			columns: [
	...
	$("#subdodelete").click(function(e){	
		...
		$.ajax({
			type: "POST",
            url: "{{ url('incomecategory/subdelete')}}",
            data: {iddelete:id},
            dataType: "JSON",
            success: function(data) {
