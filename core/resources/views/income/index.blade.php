      ...
      <div class="modal-content">
		...
		<form action="" method="POST">
          	<h5><?php echo trans('lang.istep1');?></h5>
                        <hr/>
                        <small><?php echo trans('lang.istep11');?></small><br/><br/>
                        ...
                        <hr/>
                        <p><?php echo trans('lang.istep22');?></p>
                              <small style="color:#BD1518"><?php echo trans('lang.istep23');?></small><br/><br/>
							...
							<div class="row">
								<div class="form-group col-lg-6" id="incomedate">
									...
									<div  class="input-group date" data-date-format="dd-mm-yyyy">
										<input id="idate" class="form-control" type="text" value="<?php echo date("d.m.Y");?>"/>
...
$(document).ready(function() {
	...
	$("#saveedit").click(function(e){
		...
		form.append('incomedate', date.split(".").reverse().join("-"));
	...
	$("#dodelete").click(function(e){
		...
		$('#edit').on('show.bs.modal', function(e) {
			...
			$.ajax({
				...
				success: function(data) {
					console.log(data);
					var incdate = data.message[0].transactiondate.split("-").reverse().join(".");
					...
					//$("#incomesubcategory").val(data.message[0].categoryid);$.format.date(new Date(), 'dd M yy')
					$("#idate").val(incdate);
