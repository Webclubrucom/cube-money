...
<div class=" sidebar-wrapper">
    ...
    <ul class="nav" id="scrollbar_side">
...
<footer class="footer">
    <div class="container-fluid">
        ...
        <div class="copyright pull-right">
            © <?php echo date ( 'Y' ) ; ?>. <a href="https://vk.com/webcreature" target="_blank">Разработка сайтов, онлайн-сервисов</a>
        </div>
    </div>
</footer>
</div>
