    ...
    <div class="modal-dialog">
      <div class="modal-content">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control number" required="" id="incomeamount" name="incomeamount" type="text" placeholder="<?php echo trans('lang.amount');?>">
        ...
        <div class="modal-footer">
		   <input type="submit" class="btn btn-primary btn-fill" id="saveupcoming" value="<?php echo trans('lang.save_expense');?>"/>
 ...
 <div class="modal fade" id="pay" role="dialog">
    ...
    <form action="" method="POST">
      <div class="row">
        ...
        <div class="modal-footer">
       <input type="submit" class="btn btn-primary btn-fill" id="dopay" value="<?php echo trans('lang.save');?>"/>
          <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo trans('lang.close');?></button>
        </div>
      </div>
    </div>
							...
							<div class="row">
								<div class="form-group col-lg-6" id="editincomedate">
									...
									<div  class="input-group date" data-date-format="mm-dd-yyyy">
										<input id="editidate" class="form-control" type="text" value="<?php echo date("d.m.Y");?>"/>
										<span class="input-group-addon" style="border: 1px solid #cecece;"><i class="fa fa-calendar"></i></span>
									</div>
								</div>
...
//dosave saveupcoming
	...
	$("#saveedit").click(function(e){
		...
		form.append('editincomedate', date.split(".").reverse().join("-"));
		...
		$('#edit').on('show.bs.modal', function(e) {
			...
			$.ajax({
				...
				success: function(data) {
					...
					$("#editidate").val(data.message[0].transactiondate.split("-").reverse().join("."));
