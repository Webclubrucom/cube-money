                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-8">
                                <div style="font-size:22px;">
                                    ...
                                    <span id="overall"></span><span class="currency"></span>
                                </div>
                            </div>
                        </div>
                        <div class="footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-8">
                                <div style="font-size:22px;">
                                    ...
                                    <span id="month"></span><span class="currency"></span>
                                </div>
                            </div>
                        </div>
                        <div class="footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-7">
                                <div style="font-size:22px;">
                                    ...
                                    <span id="week"></span><span class="currency"></span>
                                </div>
                            </div>
                        </div>
                        <div class="footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-7">
                                <div style="font-size:22px;">
                                    ...
                                    <span id="today"></span><span class="currency"></span>
                                </div>
                            </div>
                        </div>
                        <div class="footer">
                ...
                <div class="card">
                    <div class="header">
						<div class="row">
							...
							<div class="col-lg-6">
							<div class="pull-right"><a href="{{url('transaction/index')}}" class="btn btn-sm btn-fill btn-info"><i class="ti-plus"></i> Добавить</a></div>
      ...
      <div class="modal-content">
        ...
        <form action="" method="POST">
            <h5><?php echo trans('lang.estep1');?></h5>
                        <hr/>
                        <small><?php echo trans('lang.estep11');?></small><br/><br/>
                        <a href="upload/csv/example.csv" style="color:#2780e3"><?php echo trans('lang.download_csv');?></a><br/><br/>
                        <h5><?php echo trans('lang.estep2');?></h5>
                        <hr/>
                        <p><?php echo trans('lang.estep22');?></p>
                              <small style="color:#BD1518"><?php echo trans('lang.estep23');?></small><br/><br/>
                         <h5><?php echo trans('lang.estep3');?></h5>  
                         <hr/>
            <label class="btn-outline-primary" for="csv"><?php echo trans('lang.csv_file');?></label>                
          <input style="display:none" type="file" value="" name="csv" id="csv" />
          </form>
        </div>
        <div class="modal-footer">
           <input type="submit" class="btn btn-primary btn-fill" id="importcsv" value="<?php echo trans('lang.import');?>"/>
 ...
 <div class="modal fade" id="delete" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
		   <input type="submit" class="btn btn-primary btn-fill" id="dodelete" value="<?php echo trans('lang.delete_data');?>"/>
          <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo trans('lang.close');?></button>
        </div>
      </div>
    </div>
          ...
          <div class="modal-content">
            <form action="" method="post" id="form">
							...
							<div class="row">	
								<div class="form-group col-lg-6" id="expensedate">
									...
									<div  class="input-group date" data-date-format="mm-dd-yyyy">
										<input id="edate" class="form-control" type="text" value="<?php echo date("d.m.Y");?>"/>
              ...
              <div class="modal-footer">
                ...
                <input type="submit" class="btn btn-primary btn-fill" id="saveedit" value="<?php echo trans('lang.save');?>"/>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo trans('lang.close');?></button>
              </div>
            </form>
          </div>
...
$(document).ready(function() {
	...
	$("#saveedit").click(function(e){
		...
		form.append('expensedate', date.split(".").reverse().join("-"));
		...
		$('#edit').on('show.bs.modal', function(e) {
			...
			$.ajax({
				...
				success: function(data) {
					...
					$("#edate").val(data.message[0].transactiondate.split("-").reverse().join("."));
