                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-8">
                                <div style="font-size:22px;">
                                    <span><?php echo trans('lang.income');?> </span><br>
                                    <span id="incomemonth"></span><span class="currency"></span>
                                </div>
                            </div>
                        </div>
                        <div class="footer">
				...
				<div class="card background-red color-white">
                    <div class="content">
                        <div class="row">
                            ...
                            <div class="col-xs-8">
                                <div style="font-size:22px;">
                                    <span><?php echo trans('lang.expense');?> </span><br>
                                    <span id="expensemonth"></span><span class="currency"></span>
                                </div>
                            </div>
                        </div>
                        <div class="footer">
				...
				<div class="card background-blue-sky color-white">
                    <div class="content">
                        <div class="row">
                            ...
                            <div class="col-xs-8">
                                <div style="font-size:22px;">
                                    <span><?php echo trans('lang.net_balance');?> </span><br>
                                    <span id="monthbalance"></span><span class="currency"></span>
                                </div>
                            </div>
                        </div>
                        <div class="footer">
...
$(document).ready(function() {
	...
	//reload data on click Назад date
