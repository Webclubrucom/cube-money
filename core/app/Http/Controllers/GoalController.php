...
class GoalController extends Controller
{
	...
	public function getdata() {
		...
		->addColumn('balance', function($single) {
				...
				return number_format($single->balance, 2).' '.$setting[0]->currency;
			})
		...
		->addColumn('remaining',function($single){
				...
				return '
					...
					<div class="pull-left text-primary text-bold"><small>'.number_format($totaldeposit,2).' '.$setting[0]->currency.' ('.number_format($percentage,2).'%)</small></div><div class="pull-right"><small>'.number_format($remaining,2).' '.$setting[0]->currency.'</small></div>';
			})
