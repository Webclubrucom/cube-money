...
class IncomeTransactionController extends Controller
{
	...
	public function getdataupcoming(){
		...
		->addColumn('action', function ($accountsingle) {
				$path = 'upload/income/';
				if($accountsingle->file!=''){
					return '<a href="#" id="btnpay" customdata='.$accountsingle->transactionid.' class="btn btn-sm btn-info" data-toggle="modal" data-target="#pay"><i class="ti-wallet"></i> Получить доход</a>
